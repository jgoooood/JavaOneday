...
public class Exam_Calendar {
	public static void main(String[] args) {
		...
		//개강일
		openDate.clear();
		openDate.set(2023, 04, 15, 9, 0);
		//종강일
		closeDate.clear();
		closeDate.set(2023, 9, 26, 5, 50);
		closeDate.set(Calendar.HOUR_OF_DAY, 17);
		// Cannot make a static reference to the non-static method printCalendar(String, Calendar) 
		// from the type Exam_Calendar
		// 1. 메소드가 static이거나 2. new를 통해 객체생성해주어야 함
...
//		openDate.set(Calendar.MINUTE, 0);
	...
	public void printCalendar(String title, Calendar cal) {
		...
		int dayOfWeek 	= cal.get(Calendar.DAY_OF_WEEK); //요일을 숫자로
